 ...
 */
        ...
        function read(buffer) {
            ...
            // Preserve unsupported tables
            for(var tableName in ttf.tables) if(!supportTables[tableName]) {
                ttf[tableName] = {
                    name: tableName,
                    content: reader.readBytes(ttf.tables[tableName].offset, ttf.tables[tableName].length)
                }
            }
