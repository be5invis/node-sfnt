...
function parseCFFCharstring(code, font, index) {
	...
	var x = 0;
	var y = 0;
	var subrs, subrsBias, defaultWidthX, nominalWidthX;
	if (font.isCID) {
		var fdIndex = font.fdSelect[index];
		var fdDict = font.fdArray[fdIndex];
		subrs = fdDict.subrs;
		subrsBias = fdDict.subrsBias;
		defaultWidthX = fdDict.defaultWidthX;
		nominalWidthX = fdDict.nominalWidthX;
	} else {
		subrs = font.subrs;
		subrsBias = font.subrsBias;
		defaultWidthX = font.defaultWidthX;
		nominalWidthX = font.nominalWidthX;
	}
...
module.exports = parseCFFCharstring;